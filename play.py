...
<head>
    <head><base href="https://tellycloud-about.tech/">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>File Stream | TELLYCLOUD BOTS</title>
...
<body>
    ...
    <div class="outer">
                    ...
                    <div class="about-dets">
                        ...
                        <div class="abt-sec" id="channels">
                            ...
                            <div class="links chnl-link">
                                <a class="magnet" href="https://t.me/TELLYCLOUD_BOTS">
                                    <button>TELLYCLOUD BOTS</button>
                                </a>
                                <a class="magnet" href="https://t.me/TELLYHUB">
                                    <button>TELLYHUB</button>
                                </a>
                                <a class="magnet" href="https://t.me/HINDI_HD_PICTURESS">
                                    <button>MOVIES ZONE</button>
                                </a>
                                <a class="magnet" href="https://t.me/TELLYPRIMEHUBFREE">
                                    <button>MOVIES GROUP</button>
                                </a>
                                <a class="magnet" href="https://t.me/TELLYPRIMEHUB">
                                    <button>TellYPrimeHuB</button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="abt-sec" id="contact">
                            ...
                            <div class="links contact">
                                <a href="https://t.me/TELLYHUBSUPPORTS">
        ...
        <footer>
            ...
            <center>
                <div class="copyright">
                    <h5 class="text-center">Copyright © 2024 <a href="https://github.com/TELLYHUBCLOUD"><span
                                style="font-weight: 700;">TELLYHUB</span></a>. All
                        Rights Reserved.</h5>
                </div>
            </center>
        </footer>
